<template>
    <nav>
        <ul class="pagination pagination-sm m-0 float-right" v-if="pagination.last_page > 0" :class="sizeClass">
            <li v-if="showPrevious()" class="page-item" v-bind:class="{ 'disabled' : pagination.current_page <= 1 }">
            ...
            <li v-for="num in array" class="page-item" v-bind:class="{ 'active' : num === pagination.current_page }">
                <a class="page-link" href="#" @click.prevent="changePage(num)">{{ num }}</a>
            </li>

            <li v-if="showNext()" class="page-item" v-bind:class="{ 'disabled' : pagination.current_page === pagination.last_page || pagination.last_page === 0 }">
                <span class="page-link" v-if="pagination.current_page === pagination.last_page || pagination.last_page === 0">
