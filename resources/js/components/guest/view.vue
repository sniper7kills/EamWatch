        ...
        <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card" v-if="!this.loading">
                <div class="card-header">
                    Guest {{this.guest.name}} Profile
                    <div class="card-tools">
                        <router-link tag="a" v-if="guest.permissions.ban && !guest.banned" :to="{ name: 'guest-ban', params: { guest_id: this.guest.id } }">
                            <i class="fa fa-lock" />
                        </router-link>
                        <router-link tag="a" v-if="guest.permissions.unban && guest.banned" :to="{ name: 'guest-unban', params: { guest_id: this.guest.id } }">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Recordings</td>
                                            <td>{{this.guest.submissions.recordings}}</td>
                                        </tr>
                                        <tr>
                                            <td>Comments</td>
                                            <td>{{this.guest.submissions.comments}}</td>
                                        </tr>
                                        <tr>
                                            <td>Ratings</td>
                                            <td>{{this.guest.submissions.ratings}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
